...
//
//        System.out.printf("Array to rotate - %s. Shift Right (In Place) by %s. Result - %s%n",
//                          Arrays.toString(arrayToRotate),
//                          shiftBy, Arrays.toString(ArrayRotation.rotateInPlace(arrayToRotate, shiftBy)));
//
...
//
//        int[] numberArray = new int[]{2, 3, -7, 6, 8, 1, -10, 15};
//        System.out.printf("Lowest integer not in array %s%n",
//                          LowestIntegerNotInArray.getLowestPositiveIntegerNotInArray(numberArray));

//        String[] strings = new String[]{"flower","flow","flight"};
        String[] strings = new String[]{"c","acc","ccc"};
        System.out.printf("Longest Prefix - %s%n", LongestCommonPrefix.getLongestCommonPrefix(strings));
    }
